...
run_docker_tests() {
    ...
    if docker compose -f docker-compose.yml --profile frontend-test run --rm frontend-test bun test $extra_args; then
...
case $TEST_SUITE in
    ...
    "lint")
        ...
        docker compose -f docker-compose.yml --profile frontend-test run --rm frontend-test bun run lint || ((FAILED_TESTS++))
        ;;
    "coverage")
    ...
    "watch")
        ...
        docker compose -f docker-compose.yml --profile frontend-test run --rm frontend-test bun test --watch
        ;;
    "fast")
    ...
    "shell")
        ...
        docker compose -f docker-compose.yml --profile frontend-test run --rm frontend-test sh
        ;;
    "build")
        echo "Building frontend test image..."
        if docker compose -f docker-compose.yml --profile frontend-test build frontend-test; then
    ...
    "clean")
        ...
        docker compose -f docker-compose.yml --profile frontend-test down -v --remove-orphans
    ...
    "type-check")
        ...
        if docker compose -f docker-compose.yml --profile frontend-test run --rm frontend-test bun run lint; then
    ...
    "format")
        ...
        if docker compose -f docker-compose.yml --profile frontend-test run --rm frontend-test bun run prettier; then
